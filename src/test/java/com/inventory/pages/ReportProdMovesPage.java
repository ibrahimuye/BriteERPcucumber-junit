...
//buttons
    ...
    @FindBy (linkText = "Inventory Valuation")
    public WebElement InventoryValuation;

    @FindBy(id ="radio570_0")
    ...
    //input[@class='o_field_char o_field_widget o_input'][1]
    @FindBy(xpath = "(//input[@class='o_input'])[1]")
    public WebElement SalesPrice;

    @FindBy(xpath = "//div[@class='o_field_monetary o_field_number o_input o_field_widget']) [2]")
    ...
    public WebElement HeaderOpenCtg;
}